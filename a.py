...
class TextPreprocessor:
    ...
    def preprocess(self):
        ...
        #print("Serial Preprocessing time: {} seconds".format(end_time - start_time))
...
if __name__ == '__main__':
    with open('New Text Document 6.txt', 'r') as file:
    ...
    start_time = time.time()
    serial_preprocessed_text = preprocessor.preprocess()
    end_time = time.time()

    print("Serial Total time: {} seconds".format(end_time - start_time))

    print("Serial Preprocessing Text : ")
    print(serial_preprocessed_text)
